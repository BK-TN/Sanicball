...
{
    public class PlayerUILocal : MonoBehaviour
    {
        [SerializeField]
        ...
        private RacePlayerLocal targetPlayer;
        private RaceManagerLocal targetManager;

        private readonly Color finishedColor = new Color(0f, 0.5f, 1f);

        public RacePlayerLocal TargetPlayer
        {
        ...
        public RaceManagerLocal TargetManager
        {

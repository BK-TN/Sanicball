...
namespace Sanicball
{
	public class RaceBallSpawnerLocal : BallSpawnerLocal
	{
		...
		public BallLocal SpawnBall(int position, BallType ballType, ControlType ctrlType, int character, string nickname)
		{
